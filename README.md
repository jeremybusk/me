...
md_text = """
# **JEREMY BUSK**
Lehi, Utah | [jeremybusk@gmail.com](mailto:jeremybusk@gmail.com) | Mobile available on request  
...
## **REFERENCES**
*(Happy to provide as many career and character references as requested. These are some of the more recent references.)* * **Jens Christiansen** – Developer / Co-worker ([https://www.linkedin.com/in/jens-christiansen-23aa94101/](https://www.linkedin.com/in/jens-christiansen-23aa94101/))
...
output_path = "/mnt/data/Jeremy_Busk_ATS_Resume.pdf"
HTML(string=full_html).write_pdf(output_path)
print(f"Created PDF at {output_path}")

```
```text?code_stdout&code_event_index=2
Created PDF at /mnt/data/Jeremy_Busk_ATS_Resume.pdf

```
Your PDF file is ready
[file-tag: code-generated-file-0-1777390267448854708]

*(Note on the Markdown structure: When you merged your ConsultNet bullet points under Pyrofex in your edits, it left a disconnected paragraph ("Role Overview: Contracted for..."). For an ATS parser like Workday, a paragraph floating randomly in the middle of a list of bullet points usually breaks the job entry parsing. I combined the ConsultNet bullets into the main Pyrofex job block as a sub-project bullet so Workday parses the entire timeline smoothly as one cohesive technical block.)*

Here is the exact markdown text used to generate it:
